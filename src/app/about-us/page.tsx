...
export default function page() {
  return (
    <main className="max-w-screen-xl mx-auto p-3 mb-10">
      ...
      <p className="text-xl">
        Scopul nostru final este Comunismul, o societate lipsită de state, bani
        sau clase, unde principiul de repartiție este "De la fiecare după
        capacitate, fiecăruia după nevoie". Noi ne asociăm mișcării istorice ce
        urmărește atingerea acestui stadiu în istorie prin construcția
        socialistă.
      </p>
      <br />
      ...
      <div className="text-xl italic">
        ...
        superior al marxismului-leninismului-maoismului, comuniștii
        revoluționari au putut înțelege și mai profund învățăturile marilor
